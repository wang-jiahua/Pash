...
skew
- make -j && sudo ./test_pmem -n 20000000 -p 100000000 -t 56 -distribution skew -skew 0.99 -ps 500

uniform
- make -j && sudo ./test_pmem -n 20000000 -p 100000000 -t 56 -ps 500

mixed
- make -j && sudo ./test_pmem -n 100000000 -p 100000000 -t 56 -distribution skew -skew 0.99 -ps 500 -op mixed -r 0.5 -s 0.5

variable value length
- #define VALUE_LENGTH_VARIABLE

variable key and value length
- #include "./ePash/ePash_variable_key_value.h"
- make -j && sudo ./test_pmem -n 10000000 -p 90000000 -u 100000000 -t 56 -distribution skew -ps 1000 -vvl 64 -k variable -vkl 16
